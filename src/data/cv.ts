export const cv = {
  name: 'David Zarraga Kelly',
  title: 'Data Engineer · Solutions Architect · Palantir Specialist',
  summary: 'A highly accomplished Data Engineer and Solutions Architect with a First Class degree in Computer Science and extensive experience delivering enterprise-scale data platforms across defence, healthcare and the public sector. A recognised Palantir Foundry expert, trusted to lead high-impact projects in sensitive environments and to educate government and commercial clients across the UK, Sweden and Australia.',
  contact: {
    phone: '07535 024 330',
    email: 'hello@davidzarragakelly.com',
  },
  experience: [
    {
      company: 'Decho',
      role: 'Palantir Specialist & Consultant Engineer',
      period: 'July 2025 – Present',
      projects: [
        {
          title: 'NHS — Quality Improvement & Planning Dashboard',
